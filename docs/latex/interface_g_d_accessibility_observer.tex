...
\begin{DoxyCompactList}\small\item\em Designated initializer -\/ init with required parameters. \item\end{DoxyCompactList}\item 
(NSInvocation $\ast$) -\/ \hyperlink{interface_g_d_accessibility_observer_a737858a3d148653b014c752214009e3f}{invoker}
...
\hypertarget{interface_g_d_accessibility_observer_a737858a3d148653b014c752214009e3f}{
\index{GDAccessibilityObserver@{GDAccessibilityObserver}!invoker@{invoker}}
\index{invoker@{invoker}!GDAccessibilityObserver@{GDAccessibilityObserver}}
\subsubsection[{invoker}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (NSInvocation $\ast$) {\bf invoker} }}
\label{interface_g_d_accessibility_observer_a737858a3d148653b014c752214009e3f}


\mbox{[}Internal\mbox{]} Returns the invoker for this observer. 
